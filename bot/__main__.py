...
def _sync_download_dir():
    import bot

    download_dir = Config.DOWNLOAD_DIR.strip() if isinstance(Config.DOWNLOAD_DIR, str) else ""
    if not download_dir:
        download_dir = "/usr/src/app/downloads/"
    bot.DOWNLOAD_DIR = download_dir if download_dir.endswith("/") else f"{download_dir}/"
