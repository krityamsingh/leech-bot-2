...
DEFAULT_DESP = {
    ...
    "HELPER_STRINGS": "Additional Pyrogram user session strings for parallel Telegram transfers.",
    "HELPER_BOT_PROXIES": "Optional newline-separated proxy dicts for helper bot tokens.",
    "HELPER_USER_PROXIES": "Optional newline-separated proxy dicts for helper user sessions.",
    ...
    "HYPER_CHUNK": "HyperDL working chunk size in bytes. Default: 1024 * 1024 (1MB).",
